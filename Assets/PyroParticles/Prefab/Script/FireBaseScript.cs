...
namespace DigitalRuby.PyroParticles
{
    ...
    public class FireBaseScript : MonoBehaviour
    {
        ...
        private IEnumerator CleanupEverythingCoRoutine()
        {
            ...
            Stopping = false;//sets both starting and stoppingbooleans to false as particles and audio source tie to these two variables
            Starting = false;
            Awake();//starts these two methods asa form of looping.
            Start();
        }
        ...
        protected virtual void Update()
        {
            ...
            else if (Duration <= 0.0f && !Stopping)
            {
